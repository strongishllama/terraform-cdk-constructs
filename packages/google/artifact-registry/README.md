# @terraform-cdk-constructs/google-artifact-registry

![NPN version](https://img.shields.io/npm/v/@terraform-cdk-constructs/google-artifact-registry)
...
```
npm install @terraform-cdk-constructs/google-artifact-registry
```
