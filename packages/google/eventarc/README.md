# @terraform-cdk-constructs/google-eventarc

![NPN version](https://img.shields.io/npm/v/@terraform-cdk-constructs/google-eventarc)
...
```
npm install @terraform-cdk-constructs/google-eventarc
```
