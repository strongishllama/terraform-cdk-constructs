# @terraform-cdk-constructs/google-core

![NPN version](https://img.shields.io/npm/v/@terraform-cdk-constructs/google-core)
...
```
npm install @terraform-cdk-constructs/google-core
```
