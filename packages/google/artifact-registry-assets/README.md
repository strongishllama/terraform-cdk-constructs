# @terraform-cdk-constructs/google-artifact-registry-assets

![NPN version](https://img.shields.io/npm/v/@terraform-cdk-constructs/google-artifact-registry-assets)
...
```
npm install @terraform-cdk-constructs/google-artifact-registry-assets
```
