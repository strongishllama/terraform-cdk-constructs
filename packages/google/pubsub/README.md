# @terraform-cdk-constructs/google-pubsub

![NPN version](https://img.shields.io/npm/v/@terraform-cdk-constructs/google-pubsub)
...
```
npm install @terraform-cdk-constructs/google-pubsub
```
